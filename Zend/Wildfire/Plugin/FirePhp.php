...
class Zend_Wildfire_Plugin_FirePhp implements Zend_Wildfire_Plugin_Interface
{
     ...
     */
    const PLUGIN_URI = 'https://meta.firephp.org/Wildfire/Plugin/ZendFramework/FirePHP/1.6.2';
     ...
     */
    const STRUCTURE_URI_DUMP = 'https://meta.firephp.org/Wildfire/Structure/FirePHP/Dump/0.1';

    /**
     * The structure URI for the Firebug Console structure
     */
    const STRUCTURE_URI_FIREBUGCONSOLE = 'https://meta.firephp.org/Wildfire/Structure/FirePHP/FirebugConsole/0.1';
