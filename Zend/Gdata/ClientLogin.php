 ...
 * @see https://code.google.com/apis/accounts/AuthForInstalledApps.html
 *
 * @category   Zend
 * @package    Zend_Gdata
 * @subpackage Gdata
...
class Zend_Gdata_ClientLogin
{
     ...
     * 'HOSTED_OR_GOOGLE'. See: https://code.google.com/apis/accounts/docs/AuthForInstalledApps.html#Request
