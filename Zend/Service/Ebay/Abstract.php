...
abstract class Zend_Service_Ebay_Abstract
{
     ...
     *
     * @param  Zend_Config|array $options
     * @link   https://developer.ebay.com/DevZone/finding/Concepts/MakingACall.html#nvsyntax
     ...
     * @param  string $value
     * @param  string $type
     * @see    https://developer.ebay.com/DevZone/finding/CallRef/types/simpleTypes.html
