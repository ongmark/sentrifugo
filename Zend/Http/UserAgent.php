 ...
 *
 * - https://www.useragentstring.com/layout/useragentstring.php
 * - https://user-agent-string.info/list-of-ua
 * - https://www.user-agents.org/allagents.xml
 * - https://en.wikipedia.org/wiki/List_of_user_agents_for_mobile_phones
 * - https://www.mobilemultimedia.be/fr/
 *
 * @category   Zend
 * @package    Zend_Http_UserAgent
 * @subpackage UserAgent
