    ...
    extends Zend_Feed_Reader_Extension_EntryAbstract
{
    ...
    public function getCommentCount()
    {
        ...
        $this->getXpath()->registerNamespace('thread10', 'https://purl.org/syndication/thread/1.0');
        $list = $this->getXpath()->query(
